...
import { setThemeConfig, setIsCollapse } from "@/modules/settings";
import SwitchDark from "@/components/SwitchDark";

const Theme = (props: any) => {
	const [visible, setVisible] = useState<boolean>(false);
	const { setThemeConfig, setIsCollapse } = props;
	const { themeConfig, isCollapse } = props;
...
const mapDispatchToProps = { setThemeConfig, setIsCollapse };
